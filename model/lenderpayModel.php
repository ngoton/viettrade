...
Class lenderpayModel Extends baseModel {
	protected $table = "lender_pay";
    ...
    public function deleteLender($id){
    	if ($this->getLender($id)) {
    		return $this->delete($this->table,array('lender_pay_id'=>$id));
    	}
    }
    ...
    public function getAllLenderByWhere($id){
        return $this->query('SELECT * FROM lender_pay WHERE lender_pay_id != '.$id);
    }

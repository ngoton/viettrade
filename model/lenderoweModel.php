...
Class lenderoweModel Extends baseModel {
	protected $table = "lender_owe";
    ...
    public function deleteLender($id){
    	if ($this->getLender($id)) {
    		return $this->delete($this->table,array('lender_owe_id'=>$id));
    	}
    }
    ...
    public function getAllLenderByWhere($id){
        return $this->query('SELECT * FROM lender_owe WHERE lender_owe_id != '.$id);
    }

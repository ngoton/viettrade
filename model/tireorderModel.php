...
Class tireorderModel Extends baseModel {
	protected $table = "tire_order";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_order_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_order WHERE tire_order_id != '.$id);
    }

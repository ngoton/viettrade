...
Class tireproducerModel Extends baseModel {
	protected $table = "tire_producer";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_producer_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_producer WHERE tire_producer_id != '.$id);
    }

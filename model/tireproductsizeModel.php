...
Class tireproductsizeModel Extends baseModel {
	protected $table = "tire_product_size";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_product_size_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_product_size WHERE tire_product_size_id != '.$id);
    }

...
Class tirepatternModel Extends baseModel {
	protected $table = "tire_pattern";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_pattern_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_pattern WHERE tire_pattern_id != '.$id);
    }

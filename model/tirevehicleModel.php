...
Class tirevehicleModel Extends baseModel {
	protected $table = "tire_vehicle";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_vehicle_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_vehicle WHERE tire_vehicle_id != '.$id);
    }

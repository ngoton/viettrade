...
Class costsModel Extends baseModel {
    ...
    {    
        ...
        $id_last = $this->getLastCosts4()->costs_id;
        $data['costs_id'] = $id_last;
    ...
    public function deleteCosts($id){
    	if ($this->getCosts($id)) {
    		return $this->delete($this->table,array('costs_id'=>$id));
    	}
    }
    public function deleteCosts2($id){
        if ($this->getCosts2($id)) {
            return $this->delete2($this->table,array('costs_id'=>$id));
        }
    }
    public function deleteCosts3($id){
        $this->deleteCosts4($id);
        if ($this->getCosts3($id)) {
            return $this->delete3($this->table,array('costs_id'=>$id));
        }
    }
    public function deleteCosts4($id){
        if ($this->getCosts4($id)) {
            return $this->delete4($this->table,array('costs_id'=>$id));
        }
    }
    ...
    public function getAllCostsByWhere($id){
        return $this->query('SELECT * FROM costs WHERE costs_id != '.$id);
    }

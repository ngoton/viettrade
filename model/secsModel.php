...
Class secsModel Extends baseModel {
	protected $table = "secs";
    ...
    public function deleteCosts($id){
    	if ($this->getCosts($id)) {
    		return $this->delete($this->table,array('secs_id'=>$id));
    	}
    }
    ...
    public function getAllCostsByWhere($id){
        return $this->query('SELECT * FROM secs WHERE secs_id != '.$id);
    }

...
Class lendercostModel Extends baseModel {
	protected $table = "lender_cost";
    ...
    public function deleteLender($id){
    	if ($this->getLender($id)) {
    		return $this->delete($this->table,array('lender_cost_id'=>$id));
    	}
    }
    ...
    public function getAllLenderByWhere($id){
        return $this->query('SELECT * FROM lender_cost WHERE lender_cost_id != '.$id);
    }

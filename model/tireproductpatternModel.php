...
Class tireproductpatternModel Extends baseModel {
	protected $table = "tire_product_pattern";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_product_pattern_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_product_pattern WHERE tire_product_pattern_id != '.$id);
    }

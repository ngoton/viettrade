...
Class customertiretypeModel Extends baseModel {
	protected $table = "customer_tire_type";
    ...
    public function deleteCustomer($id){
    	if ($this->getCustomer($id)) {
    		return $this->delete($this->table,array('customer_tire_type_id'=>$id));
    	}
    }
    ...
    public function getAllCustomerByWhere($id){
        return $this->query('SELECT * FROM customer_tire_type WHERE customer_tire_type_id != '.$id);
    }

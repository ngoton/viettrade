...
Class tireproductModel Extends baseModel {
	protected $table = "tire_product";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_product_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_product WHERE tire_product_id != '.$id);
    }

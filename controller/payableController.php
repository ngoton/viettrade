...
Class payableController Extends baseController {
    ...
    public function approve(){
        ...
        if (isset($_POST['data'])) {
            ...
            date_default_timezone_set("Asia/Ho_Chi_Minh"); 
                        $filename = "action_logs.txt";
                        $text = date('d/m/Y H:i:s')."|".$_SESSION['user_logined']."|"."approve"."|".$_POST['data']."|payable|"."\n"."\r\n";
    ...
    public function approve2(){
        ...
        if (isset($_POST['data'])) {
            ...
            date_default_timezone_set("Asia/Ho_Chi_Minh"); 
                        $filename = "action_logs.txt";
                        $text = date('d/m/Y H:i:s')."|".$_SESSION['user_logined']."|"."approve2"."|".$_POST['data']."|payable|"."\n"."\r\n";
    ...
    public function approve3(){
        ...
        if (isset($_POST['data'])) {
            ...
            date_default_timezone_set("Asia/Ho_Chi_Minh"); 
                        $filename = "action_logs.txt";
                        $text = date('d/m/Y H:i:s')."|".$_SESSION['user_logined']."|"."approve3"."|".$_POST['data']."|payable|"."\n"."\r\n";
            ...
            if ($data['lender'] > 0) {
                ...
                $costs = $this->model->get('costsModel');
                    ...
                    $data_costs = array(
                        ...
                        'comment' => 'CMG tạm ứng '.trim($_POST['comment']),
                    ...
                    $id_temp = $costs->getLastCosts3()->costs_id;
        ...
        if (isset($_POST['yes'])) {
            ...
            if ($_POST['yes'] != "") {
                ...
                $data['approve'] = null;
                    ...
                    if ($payable_data->money >= $data['money'] && $payable_data->approve > 0) {
                        $data['approve'] = 10;
                    }
                    ...
                    $data['payable_create_date'] = strtotime(date('d-m-Y H:i:s'));

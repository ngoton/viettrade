<?php
Class tirepriceController Extends baseController {
    public function index() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $order = $this->registry->router->order_by ? $this->registry->router->order_by : 'ASC, tire_size_number ASC, price_start_time ASC';

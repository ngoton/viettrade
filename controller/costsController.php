            ...
            if ($_POST['yes'] != "") {
                ...
                if ($costs_data->lender > 0) {
                    ...
                    if ($data['lender'] != 1) {
                        ...
                        $costs->queryCosts3('DELETE FROM costs WHERE staff=27 AND costs_date='.$costs_data->pay_date.' AND money='.$costs_data->pay_money);
                        $assets_model->queryAssets3('DELETE FROM assets WHERE total='.(0-$costs_data->pay_money).' AND costs='.$_POST['yes']);
                        $receivable->queryCosts3('DELETE FROM receivable WHERE staff=27 AND receivable_date='.$costs_data->pay_date.'  AND money='.$costs_data->pay_money);
                        $staff_debt_model->queryCost3('DELETE FROM staff_debt WHERE staff=27 AND staff_debt_date='.$costs_data->pay_date.' AND money='.$costs_data->pay_money);
                    }
                    else{
                        ...
                        $costs->updateCosts3($data_costs,array('staff'=>27,'costs_date'=>$costs_data->pay_date,'money'=>$costs_data->pay_money));
                        ...
                        $staff_debt_model->updateCost3($data_staff_debt,array('staff'=>27,'money'=>$costs_data->pay_money,'staff_debt_date'=>$costs_data->pay_date));
                        ...
                        $receivable->updateCosts3($data_receivable,array('staff'=>27,'money'=>$costs_data->pay_money,'receivable_date'=>$costs_data->pay_date));
                    }
                }
